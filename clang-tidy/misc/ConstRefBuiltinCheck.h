...
class ConstRefBuiltinCheck : public ClangTidyCheck {
public:
  ConstRefBuiltinCheck(StringRef Name, ClangTidyContext *Context)
...
#endif // LLVM_CLANG_TOOLS_EXTRA_CLANG_TIDY_MISC_CONST_REF_BUILTIN_H
